...
- [basic-pubky-app](basic-pubky-app/) - Minimal Vite + TypeScript app with Pubky Auth, optional Passport popup support, file storage, and an event stream subscription:
